...
if ['12.2.1', '12.2.1.1', '12.2.1.2','12.2.1.3', '12.1.3', '12.1.2'].include?(node['fmw']['version'])
  if node['fmw']['version'] == '12.1.3'
    ...
    wls_em_template      = "#{node['fmw']['middleware_home_dir']}/em/common/templates/wls/oracle.em_wls_template_12.2.1.3.jar"
    wls_jrf_template     = "#{node['fmw']['middleware_home_dir']}/oracle_common/common/templates/wls/oracle.jrf_template_12.2.1.3.jar"
  else

...
describe 'fmw_wls::install' do
  ...
  describe file('/usr/jdk/instances/jdk1.8.0_171') do
    it { should be_directory }
    it { should be_owned_by 'root' }
  end

  describe file('/usr/jdk/instances/jdk1.8.0_171/bin/java') do
    it { should be_file }
    it { should be_owned_by 'root' }
  ...
  describe file('/usr/bin/java') do
    ...
    it { should be_linked_to '/usr/jdk/instances/jdk1.8.0_171/bin/java' }
  end
